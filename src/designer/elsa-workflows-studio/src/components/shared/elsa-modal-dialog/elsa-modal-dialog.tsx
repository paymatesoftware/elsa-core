  ...
  renderModal() {
    return (
      <Host class={{'hidden': !this.isVisible, 'elsa-block': true}}>
        <div class="elsa elsa-fixed elsa-z-1000 elsa-inset-0 elsa-overflow-y-auto">
          <div
            class="elsa elsa-flex elsa-items-end elsa-justify-center elsa-min-h-screen elsa-pt-4 elsa-px-4 elsa-pb-20 elsa-text-center sm:elsa-block sm:elsa-p-0">
            <div ref={el => this.overlay = el}
                 ...
                 class="elsa hidden elsa-fixed elsa-inset-0 elsa-transition-opacity" aria-hidden="true">
              <div class="elsa elsa-absolute elsa-inset-0 elsa-bg-gray-500 elsa-opacity-75"/>
            </div>

            <span class="elsa hidden sm:elsa-inline-block sm:elsa-align-middle sm:elsa-h-screen" aria-hidden="true"/>
            <div ref={el => this.modal = el}
                 ...
                 class="elsa hidden elsa-inline-block sm:elsa-align-top elsa-bg-white elsa-rounded-lg elsa-text-left elsa-overflow-visible elsa-shadow-xl elsa-transform elsa-transition-all sm:elsa-my-8 sm:elsa-align-top sm:elsa-max-w-4xl sm:elsa-w-full"
                 role="dialog" aria-modal="true" aria-labelledby="modal-headline">
              <div class="elsa modal-content">
                <slot name="content"/>
              </div>
