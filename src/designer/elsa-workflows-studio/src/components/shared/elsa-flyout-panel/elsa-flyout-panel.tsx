  ...
  render() {
    ...
    return (
      <Host>
        <button type="button"
                onClick={this.toggle}
                class={`elsa ${expanded ? "elsa-hidden" : expandPositionClass} workflow-settings-button elsa-fixed elsa-top-20 elsa-inline-flex elsa-items-center elsa-p-2 elsa-rounded-full elsa-border elsa-border-transparent elsa-bg-white shadow elsa-text-gray-400 hover:elsa-text-blue-500 focus:elsa-text-blue-500 hover:elsa-ring-2 hover:elsa-ring-offset-2 hover:elsa-ring-blue-500 focus:elsa-outline-none focus:elsa-ring-2 focus:elsa-ring-offset-2 focus:elsa-ring-blue-500 elsa-z-1000`}>
          <svg xmlns="http://www.w3.org/2000/svg" class="elsa elsa-h-8 elsa-w-8" fill="none" viewBox="0 0 24 24"
               stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 19l-7-7 7-7m8 14l-7-7 7-7"/>
          </svg>
        </button>
        <section
          class={`elsa ${this.expanded ? '' : 'elsa-hidden'} elsa-fixed elsa-top-4 elsa-right-0 elsa-bottom-0 elsa-overflow-hidden`}
          aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
          <div class="elsa elsa-absolute elsa-inset-0 elsa-overflow-hidden">
            <div class="elsa elsa-absolute elsa-inset-0" aria-hidden="true"/>
            <div
              class="elsa elsa-fixed elsa-top-20 elsa-inset-y-0 elsa-right-2 elsa-bottom-2 max-elsa-w-full elsa-flex">
              <div
                ref={el => this.el = el}
                ...
                class="elsa elsa-w-screen elsa-max-w-lg elsa-h-full ">
                <button type="button"
                        onClick={this.toggle}
                        class="elsa elsa workflow-settings-button elsa-absolute elsa-left-2 elsa-inline-flex elsa-items-center elsa-p-2 elsa-rounded-full elsa-border elsa-border-transparent elsa-bg-white shadow elsa-text-gray-400 hover:elsa-text-blue-500 focus:elsa-text-blue-500 hover:elsa-ring-2 hover:elsa-ring-offset-2 hover:elsa-ring-blue-500 focus:elsa-outline-none focus:elsa-ring-2 focus:elsa-ring-offset-2 focus:elsa-ring-blue-500 elsa-z-1000">
                  <svg xmlns="http://www.w3.org/2000/svg" class="elsa elsa-h-8 elsa-w-8" fill="none" viewBox="0 0 24 24"
                       stroke="currentColor">
                ...
                <div
                  class="elsa elsa-h-full elsa-flex elsa-flex-col elsa-py-6 elsa-bg-white elsa-shadow-xl elsa-bg-white">
                  <div class="elsa elsa-h-full elsa-mt-8 elsa-p-6 elsa-flex elsa-flex-col">
                      <div class="elsa elsa-border-b elsa-border-gray-200">
                        <nav class="elsa -elsa-mb-px elsa-flex elsa-space-x-8" aria-label="Tabs">
                          <slot name="header"/>
                        </nav>
                      </div>
                      <section class="elsa elsa-overflow-auto elsa-h-full">
                        <slot name="content"/>
                      </section>
                    </div>
                  </div>
